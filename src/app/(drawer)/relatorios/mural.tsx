        ...
        <View className="pt-4">
          <View className="mb-6">
            <Text className="mb-2 font-extrabold text-3xl text-text">
              {t("reports.mural.title")}
            </Text>
            <Text className="text-base text-muted">{t("reports.mural.subtitle")}</Text>
          </View>
          ...
          {loading ? (
                  ...
                  <View className="mb-4 flex-row items-center justify-between">
                    <View className="flex-row items-center gap-3">
                      ...
                      <Text className="font-bold text-lg text-text">
                        {t("reports.mural.employeeOfMonth")}
                      </Text>
                    </View>
                    <View className="rounded-full bg-primary/10 px-3 py-1">
                      <Text className="font-semibold text-primary text-xs">
                        ...
                        {t(
                          funcionario.numeroIndicacoes === 1
                            ? "reports.mural.recognition"
                            : "reports.mural.recognitions"
                        )}
                      </Text>
                    </View>
                  </View>
                    ...
                    <View className="rounded-xl bg-primary/5 p-4">
                      <View className="mb-2 flex-row items-center gap-2">
                        ...
                        <Text className="font-semibold text-sm text-primary">
                          {t("reports.mural.recognitionMessage")}
                        </Text>
                      </View>
                      <Text className="leading-5 text-sm text-text">
                        "{funcionario.mensagemReconhecimento}"
                      </Text>
                      <Text className="mt-2 text-right text-muted text-xs">
                        {t("reports.mural.generatedByAI")}
                      </Text>
                    </View>
                  )}
                </View>
            ...
            <View className="flex-1 items-center justify-center py-20">
              ...
              <Text className="mt-4 text-center text-base text-text">
                {t("reports.mural.noEmployeesTitle")}
              </Text>
              <Text className="mt-2 text-center text-sm text-muted">
                {t("reports.mural.noEmployeesMessage")}
              </Text>
            </View>
          )}
        </View>
